    ...
    enum OPTTYPE {OPT_INVALID, OPT_CALL, OPT_PUT};
    enum SENSTYPE {SENS_ALLSENS = -1, SENS_INVALID, SENS_PRICE, SENS_DELTA, SENS_GAMMA, SENS_VEGA,
    					SENS_THETA, SENS_RHO, SENS_DELTA2, SENS_GAMMA2,
   					SENS_VEGA2, SENS_CORR, SENS_MAX};
 
    enum SEQTYPE {SEQ_INVALID, SEQ_EXACT, SEQ_EXTENDIBLE};
